...
public class LocatorHelper {
    public static By toBy(String locator) {
        ...
        switch (by) {
            ...
            case "partial_link": return By.partialLinkText(value);
            case "name": return By.name(value);
            case "tag": return By.tagName(value);
            case "class": return By.className(value);
            case "css": return By.cssSelector(value);
            case "ios_uiautomation": return MobileBy.IosUIAutomation(value);
            case "android_uiautomator": return MobileBy.AndroidUIAutomator(value);
